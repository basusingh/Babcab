      ...
      <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
        <tr>
          <td align='center' valign='top' style='padding: 36px 24px;'>
            <a href='' style='font-size:3.4em;color: #00466a;text-decoration:none;font-weight:600'>Food and Smile</a>
          </td>
        </tr>
      </table>
      <!--[if (gte mso 9)|(IE)]>
    ...
    <td align='center' bgcolor='#e9ecef'>
      ...
      <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
        ...
        <tr>
          ...
          <p style='margin: 0;'>Tap the button below to confirm your email address. If you didn't create an account with <a href=''>Foor For All</a>, you can safely delete this email.</p>
          </td>
        </tr>
        <!-- end copy -->
                  ...
                  <table border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td align='center' bgcolor='#1a82e2' style='border-radius: 6px;'>
                        <a href='.$link.' target='_blank' style='display: inline-block; padding: 16px 36px; font-family: Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;'>Confirm Email</a>
                      </td>
                    </tr>
                  </table>
                </td>
        ...
        <tr>
          ...
          <p style='margin: 0;'><a href='' target='_blank'>   <a href='' style='color: #00466a;text-decoration:none;font-weight:600'>Food and Smile</a> </a></p>
          </td>
        </tr>
        <!-- end copy -->
        ...
        <tr>
          ...
          <p style='margin: 0;'>Cheers,<br> Team Food and Smile</p>
          </td>
        </tr>
        <!-- end copy -->
    ...
    <td align='center' bgcolor='#e9ecef' style='padding: 24px;'>
      ...
      <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
        ...
        <tr>
          ...
          <p style='margin: 0;'>Food and Smile, Pune, India</p>
          </td>
        </tr>
        <!-- end unsubscribe -->
